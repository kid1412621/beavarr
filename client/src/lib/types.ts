...
export const aiSettingsSchema = z.object({
    ...
    openaiBaseUrl: z.union([z.url(), z.literal('')]).nullable().optional(),
    openaiModel: z.string().nullable().optional(),
});

export const mediaSettingsSchema = z.object({
    sonarrUrl: z.union([z.url(), z.literal('')]).nullable().optional(),
    sonarrApiKey: z.string().nullable().optional(),
    radarrUrl: z.union([z.url(), z.literal('')]).nullable().optional(),
